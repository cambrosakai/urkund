 ...
 *
 * Copyright (c) 2007 Virginia Polytechnic Institute and State University Licensed under the Educational Community License version 1.0
 *
 * A copy of the Educational Community License has been included in this distribution and is available at: http://www.opensource.org/licenses/ecl1.php
 *
 * Contributors: Aaron Zeckoski (aaronz@vt.edu) - primary
 *
 ****************************************************************************
 */
...
public class ContentReviewDaoImplTest extends AbstractTransactionalSpringContextTests {
    ...
    private ContentReviewItemUrkund contentReviewItemLocked;
    private ContentReviewItemUrkund contentReviewItemUnlocked;
    private ContentReviewItemUrkund contentReviewItemLockedExp;
    ...
    /**
     * ADD unit tests below here, use testMethod as the name of the unit test, Note that if a method is overloaded you should include the arguments in the test
     * name like so: testMethodClassInt (for method(Class, int);
     */
